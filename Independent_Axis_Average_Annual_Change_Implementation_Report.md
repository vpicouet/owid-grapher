...
export class GrapherState {
    ...
    @computed get isRelativeMode(): boolean {
        ...
        return (
            this.isOnScatterTab &&
            (!!this.xAxisAverageAnnualChange || !!this.yAxisAverageAnnualChange)
        )
    }
...
export class ScatterPlotChartState {
    @computed get transformedTable(): OwidTable {
        ...
        if (this.hasAnyRelativeMode) {
            ...
            if (columnsToTransform.length > 0) {
                table =
                    table.toAverageAnnualChangeForEachEntity(columnsToTransform)
            }
        }
    ...
    @computed get xScaleType(): ScaleType {
        const hasXRelative =
            this.manager.xAxisAverageAnnualChange || this.legacyIsRelativeMode
        return hasXRelative
            ? ScaleType.linear
    ...
    @computed get yScaleType(): ScaleType {
        const hasYRelative =
            this.manager.yAxisAverageAnnualChange || this.legacyIsRelativeMode
        return hasYRelative
            ? ScaleType.linear
...
```typescript
export class AddIndependentAxisAverageAnnualChange
